...
if (!empty($_SESSION['user_id']) or isset($_SESSION['user_id'])){
    if ( $_SESSION['user_auth'] != 'Y' ) header( "Location: lockscreen.php" );
} 
else{
    unset($_SESSION);
    session_destroy();
...
require_once('controls/adminFunctions.php');
...
<head>
	...
	<meta http-equiv="refresh" content="1500000; url=loockscreen/?return=<?php echo base64_encode($return) ?>">
...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="admin/home" class="logo hidden-xs" style="position: fixed">
                    ...
                    <LI CLASS="dropdown messages-menu hidden">
                        ...
                        <UL CLASS="dropdown-menu">
                            <LI>
                                ...
                                <UL CLASS="menu text-darkgray" STYLE="color:#333 !important"></UL>
                            </LI>
                        </UL>
                    </LI>
                    ...
                    <LI CLASS="dropdown user user-menu">
                        ...
                        <UL CLASS="dropdown-menu">
                            ...
                            <LI CLASS="user-footer">
                                <DIV CLASS="pull-left">
                                    <a href="admin/my_account" class="btn btn-default btn-flat" title="Minha conta"><i class="fa fa-user" aria-hidden="true"></i></a>
                                </DIV>
                                <DIV CLASS="pull-left">
                                    <a href="loockscreen/?return=<?php echo base64_encode($return) ?>" class="btn btn-warning btn-flat" title="Bloquear tela"><i class="fa fa-lock" aria-hidden="true"></i></a>
                                </DIV>
                                <DIV CLASS="pull-left">
                                    <a href="controls/logout.php" class="btn btn-danger btn-flat" title="Sair"><i class="fa fa-power-off" aria-hidden="true"></i></a>
                                </DIV>
                            </LI>
                        </UL>
                    </LI>
            ...
            <UL CLASS="sidebar-menu">
                ...
                ?>             
                    <LI CLASS="treeview">
                        ...
                        <UL CLASS="treeview-menu">
                            <LI CLASS="active"><a href="/app/admin/news"><SPAN>Editar NotÃ­cias</SPAN></a>
                            </LI>
                            <LI><a href="admin/edit_news"><SPAN>Escrever NotÃ­cia</SPAN></a>
                            </LI>
                        </UL>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI CLASS="treeview">
                        ...
                        <UL CLASS="treeview-menu">
                            ...
                            <LI><a href="admin/add_products"><SPAN>Adicionar Produtos</SPAN></a></LI>
                        </UL>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI CLASS="treeview">
                        ...
                        <UL CLASS="treeview-menu">
                            <LI CLASS="active"><a href="/app/admin/vehicles"><SPAN>VeÃ­culos</SPAN></a>
                            </LI>
                            <LI><a href="admin/add_cars"><SPAN>Adicionar Carros</SPAN></a>
                            </LI>
                            <LI><a href="admin/add_motorcycles"><SPAN>Adicionar Motos</SPAN></a>
                            </LI>
                            <LI><a href="admin/statistics_vehicles"><SPAN>EstatÃ­sticas</SPAN></a>
                            </LI>
                            <LI><a href="admin/settings_vehicles"><SPAN>ConfiguraÃ§Ãµes</SPAN></a>
                            </LI>
                        </UL>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI CLASS="treeview">
                        ...
                        <UL CLASS="treeview-menu">
                            <LI CLASS="active"><a href="app/admin/properties"><SPAN>ImÃ³veis Cadastrados</SPAN></a></LI>
                            <LI><a href="admin/add_properties"><SPAN>Cadastrar ImÃ³veis</SPAN></a></LI>
                            <LI class="hidden"><a href="admin/settings_properties"><SPAN>ConfiguraÃ§Ãµes</SPAN></a></LI>
                        </UL>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI CLASS="treeview">
                        ...
                        <UL CLASS="treeview-menu">
                            <LI CLASS="active"><a href="admin/clients"><SPAN>Clientes</SPAN></a></LI>
                            <LI><a href="admin/add_clients"><SPAN>Cadastrar Cliente</SPAN></a></LI>
                        </UL>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI CLASS="treeview">
                        ...
                        <UL CLASS="treeview-menu">
                            ...
                            <LI><a href="admin/add_contracts"><SPAN>Novo Contrato</SPAN></a></LI>
                            <LI><a href="admin/new_template_contracts"><SPAN>Novo Modelo de Contrato</SPAN></a></LI>
                        </UL>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI>
                        <a href="admin/scrapbook"><div class="icons_sys" id="sprites-scrapbook"></div><span>RECADOS</span></a>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI CLASS="">
                        <a href="admin/survey"><div class="icons_sys" id="sprites-survey"></div><span>ENQUETE</SPAN></a>
                    </LI>
                <?php endif; ?>
                
                <?php  
                if( ( in_array('galery', $active_modules)) and ($_SESSION['user_type'] === 'administrador' or $_SESSION['user_type'] === 'suporte' or isset($_SESSION['gallery_view'])) ) :
                ?>
                    <LI>
                        <a href="admin/gallery"><div class="icons_sys" id="sprites-survey"></div><SPAN>GALERIA</SPAN></a>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI>
                        <a href="admin/slides"><div class="icons_sys" id="sprites-slides"></div><SPAN>SLIDES</SPAN></a>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI>
                        <a href="admin/top"><div class="icons_sys" id="sprites-top-list"></div><SPAN>TOP 10</SPAN></a>
                    </LI>   
                <?php endif; ?>
                ...
                ?>
                    <LI>
                        <a href="admin/advertising"><div class="icons_sys" id="sprites-advertising"></div><SPAN>PUBLICIDADE</SPAN></a>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI CLASS="">
                        <a href="admin/statistics"><div class="icons_sys" id="sprites-statistics"></div><SPAN>RELATÃ“RIOS DE ACESSO</SPAN></a>
                    </LI>
                <?php endif; ?>
                ...
                ?>
                    <LI>
                        <a href="javascript:;">
                            ...
                            <span>USUÃ�RIOS</span> <I CLASS="fa fa-angle-left pull-right"></I>
                        </a>
                        <UL CLASS="treeview-menu">
                            <LI CLASS="active"><a href="admin/users"><SPAN>UsuÃ¡rios</SPAN></a></LI>
                            <LI><a href="admin/new_user"><SPAN>Novo UsuÃ¡rio</SPAN></a></LI>
                        </UL>
                    </LI>
                    <LI CLASS="treeview hidden">
                        <a href="app/admin/settings">
                            <div class="icons_sys" id="sprites-configurations"></div>
                            <SPAN>CONFIGURAÃ‡Ã•ES GERAIS</SPAN><I CLASS="fa fa-angle-left pull-right"></I>
                        </a>
                        <UL CLASS="treeview-menu">
                            <LI><a href="admin/site_settings"><SPAN>ConfiguraÃ§Ãµes do Site</SPAN></a></LI>
                            <LI><a href="admin/system_settings"><SPAN>ConfiguraÃ§Ãµes do Sistema</SPAN></a></LI>
                        </UL>
                    </LI>
                <?php endif; ?>           
    ...
    <FOOTER CLASS="main-footer">
        ...
        <STRONG>Copyright <?php auto_copyright($startYear = 2016); ?> <a href="http://loires.com.br"> - Loires - SoluÃ§Ãµes Integradas</a>.</STRONG> Todos os direitos reservados.
    </FOOTER>
    ...
    <ASIDE CLASS="control-sidebar control-sidebar-dark">
        ...
        <DIV CLASS="tab-content">
            ...
            <DIV CLASS="tab-pane" ID="control-sidebar-settings-tab">
             <a href="javascript:;" class="link" data-control="active-desktop-notification"><i class="fa fa-bullhorn"></i> Ativar Desktop notificaÃ§Ãµes.</a> 
            </DIV>
            <!-- /.tab-pane -->
        </DIV>
    </ASIDE>
...
<script src="../plugins/bootstrap-validator-master/dist/validator.min.js"></script>
<!-- Ativa aÃ§Ãµes de mouse das widgets jQuery Ui no celular -->
...
<script src="javascript/loadHelp.js"></script>
<!-- EagerImageLoader -->
...
<script async defer>
$(document).ready(function(){
    $('#users-status-load').load("modules/users/users_status.php", {status: '1'});
    setInterval(function() {$('#users-status-load').load("modules/users/users_status.php", {status: '1'});
    }, 5000);
    
    setInterval(function() {$('#recent_activity').load("modules/users/users_activity.php");
    }, 5000);
