...
$return = isset($_GET['return']) ? base64_decode($_GET['return']) : 'admin/home' ;
...
<META http-equiv="refresh" content="3600; url=controls/logout.php">
...
<div class="lockscreen-wrapper" style="background-color: #FFFFFFB3;padding: 30px 15px;border-radius: 5px;">
  ...
  <div class="lockscreen-item">
    ...
    <form class="lockscreen-credentials" action="controls/reAuthUser.php" method="post" name="form-reauth" id="form-reauth" enctype="application/x-www-form-urlencoded" autocomplete="off">
  ...
  <div class="text-center">
    <a href="controls/logout.php">Ou faça login com um usuário diferente</a>
  </div>
...
$(document).ready(function(){
    ...
    setInterval(function() {$.get('modules/users/users_status.php', {status: '2'} );
    }, 5000);
