       ...
       <form name="form-publicidade" id="form-publicidade" method="POST" action="/app/modules/advertising/insert_advert.php" role="form"  enctype="multipart/form-data" data-post="FormData">      
        <DIV CLASS="box-body">
          ...
          <DIV CLASS="form-group">
            ...
            <I CLASS="fa fa-question-circle pull-right color-verde" ARIA-HIDDEN="true" ROLE="button" DATA-PLACEMENT="auto" DATA-TOGGLE="popover" DATA-CONTAINER="body" DATA-HTML="true" DATA-TRIGGER="focus" TITLE="<strong>Ayuda</strong>" DATA-CONTENT="Nome da empresa ou anunciante para controle."></I>
