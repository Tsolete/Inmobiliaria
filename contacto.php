...
<div class="bg-top">
	<div class="container">
		<ol class="breadcrumb">
		  <li><a href="inicip.php">Inicio</a></li>
				...
				<div class="contact-form">
					<form name="sentMessage-tirar" id="contactForm" enctype="application/x-www-form-urlencoded" method="post" action="envia2.php">
						<div CLASS="form-group row">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px;">
								<input type="tel" class="form-control" id="telefone" name="telefone" placeholder="Telefono*" required>
							</div>
							<div CLASS="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<textarea style="resize:none; height:100px;" type="text" class="form-control" id="mensagem" name="mensagem" placeholder="Mensaje*" required></textarea>
							</div>
						</div>
